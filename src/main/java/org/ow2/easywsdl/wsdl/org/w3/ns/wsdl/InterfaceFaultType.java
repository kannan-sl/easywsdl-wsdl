    ...
    implements CopyTo, Copyable, Equals, HashCode, ToString
{
    ...
    public void equals(Object object, EqualsBuilder equalsBuilder) {
        if (!(object instanceof InterfaceFaultType)) {
    ...
    public Object copyTo(Object target, CopyBuilder copyBuilder) {
        final InterfaceFaultType copy = ((target == null)?((InterfaceFaultType) createCopy()):((InterfaceFaultType) target));
        ...
        }
        {
            ...
            String copyElement = ((String) copyBuilder.copy(sourceElement));
