...
public class TDocumented implements CopyTo, Copyable, Equals, HashCode, ToString
{
    ...
    public Object copyTo(Object target, CopyBuilder copyBuilder) {
        final TDocumented copy = ((target == null)?((TDocumented) createCopy()):((TDocumented) target));
        {
            TDocumentation sourceDocumentation;
            sourceDocumentation = this.getDocumentation();
            TDocumentation copyDocumentation = ((TDocumentation) copyBuilder.copy(sourceDocumentation));
